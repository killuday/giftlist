                ...
                <div className='max-w-2xl mx-auto my-8 p-6 bg-white rounded-lg text-center'>
                    ...
                    <form className="max-w-lg mx-auto" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-4 ">
                            ...
                            />
                            {errors.giftType &&
                                <p className="text-red-500 text-left pt-2 text-xs">Please select gift type</p>}
                        </div>
                        <div className="mb-4">
                            ...
                            <div className='flex items-center gap-x-4'>
                                <div className='w-[20%]'>
                                    <Input
                                        className={`${errors.currency ? "border-red-500 placeholder:text-red-500 " : "placeholder:text-[#818694]"} w-full text-center  text-black`}
                                        id="spendAmount"
                                ...
                                <div className='w-[20%]'>
                                    <Input
                                        className={`${errors.spendAmount ? "border-red-500 placeholder:text-red-500" : "placeholder:text-[#818694]"} w-full text-center text-black`}
                                        id="spendAmount"
                                        placeholder="Amount..."
                        ...
                        <div className="mb-4">
                            ...
                            />
                            {errors.country &&
                                <p className="text-red-500 text-left pt-2 text-xs">Please select country</p>}
                        </div>
                        <div className="flex justify-between items-center">
                            ...
                            <Button variant='secondary' type='submit'
                                ...
                                <img src='/images/shine.svg' className='h-[22px] w-[22px]' alt='icon'/> Generate Gift
                                Ideas
                            </Button>
                        </div>
